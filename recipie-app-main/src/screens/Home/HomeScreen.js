...
import { FlatList, Text, View, TouchableHighlight, Image, TouchableOpacity, SectionList, ImageBackground } from "react-native";  // Import ImageBackground
...
export default function HomeScreen(props) {
  ...
  return (
    <ImageBackground
      source={require("../../../assets/wallpaper-1.png")}  // Set your image URL here
      style={{ flex: 1 }}
    >
      <View style={{ flex: 1 }}>
        <SectionList
